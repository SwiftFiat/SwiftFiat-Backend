...
func (k *KYC) validateBVN(ctx *gin.Context) {
	...
	entry := audit.NewLog(
		ctx, 
		audit.CategoryKYC, 
		audit.EventBVNVerified,
		fmt.Sprint(kyc.ID),
		fmt.Sprintf("User %s verified BVN", activeUser.Email),
		&activeUser.UserID,
		activeUser.Role,
		true,
		nil,
...
func (k *KYC) validateNIN(ctx *gin.Context) {
	...
	entry := audit.NewLog(
		ctx, 
		audit.CategoryKYC, 
		audit.EventNINVerified,
		fmt.Sprint(kyc.ID),
		fmt.Sprintf("User %s verified NIN", activeUser.Email),
		&activeUser.UserID,
		activeUser.Role,
		true,
		nil,
...
func (k *KYC) verifyUtilityBill(ctx *gin.Context) {
	...
	entry := audit.NewLog(
		ctx, 
		audit.CategoryKYC, 
		audit.EventUtilityBillVerified,
		fmt.Sprint(updatedKycRecord.ID),
		fmt.Sprintf("User %s verified utility bill", activeUser.Email),
		&activeUser.UserID,
		activeUser.Role,
		true,
		nil,
