...
// 	var filter RewardHistoryFilter
...
// 		ctx.JSON(http.StatusForbidden, basemodels.NewError(apistrings.AdminAccessRequired))
// 		return
// 	}

// 	var req CreateRewardConfigRequest
...
// 	config, err := server.rewardService.CreateRewardConfiguration(ctx.Request.Context(), req, adminID)
// 	if err != nil {
