...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/admin/subscriptions/merchants": {
            "get": {
        ...
        "/api/v1/admin/subscriptions/merchants/list": {
            "get": {
        ...
        "/api/v1/admin/subscriptions/merchants/{id}": {
            "patch": {
        ...
        "/api/v1/admin/subscriptions/merchants/{merchant_id}": {
            "get": {
