...
import (
	...
	"github.com/SwiftFiat/SwiftFiat-Backend/internal/common/utils"
	wallet "github.com/SwiftFiat/SwiftFiat-Backend/internal/wallet/handler"
...
func NewServer(envPath string) *Server {
	...
	// Should this be set in the server class or in the main class
	utils.SetTokenController(utils.NewJWTToken(c))
...
func (s *Server) Start() error {
	...
	// KYC{}.router(s)
	// GiftCard{}.router(s)
	w := wallet.NewWalletHandler(&wallet.WalletDependencies{
		Router: s.router,
		Logger: s.logger,
		Store:  s.store,
	})
